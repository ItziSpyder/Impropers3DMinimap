...
import io.github.itzispyder.impropers3dminimap.render.ui.elements.config.settings.types.DoubleSettingElement;
...
public class DoubleSetting extends NumberSetting<Double> {
    ...
    public DoubleSettingElement toGuiElement(int x, int y) {
        return new DoubleSettingElement(this, x, y, 200 - 20);
    }
