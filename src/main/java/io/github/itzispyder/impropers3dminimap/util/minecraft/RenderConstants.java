...
public class RenderConstants {
    ...
    public static final RenderLayer LINES = RenderLayer.of("coherent_layer_lines", 256, PIPELINE_LINES, emptyParams());
    public static final RenderLayer LINES_STRIP = RenderLayer.of("coherent_layer_lines_strip", 256, PIPELINE_LINES_STRIP, emptyParams());
    public static final RenderLayer QUADS = RenderLayer.of("coherent_layer_quads", 256, PIPELINE_QUADS, emptyParams());
    public static final RenderLayer TRI_FAN = RenderLayer.of("coherent_layer_tri_fan", 256, PIPELINE_TRI_FAN, emptyParams());
    public static final RenderLayer TRI_STRIP = RenderLayer.of("coherent_layer_tri_strip", 256, PIPELINE_TRI_STRIP, emptyParams());
    public static final RenderLayer TRI = RenderLayer.of("coherent_layer_tri", 256, PIPELINE_TRI, emptyParams());
    public static final Function<Identifier, RenderLayer> TEX_QUADS = id -> RenderLayer.of("coherent_layer_tex_quad", 256, PIPELINE_TEX_QUADS, textureParams(id));
    public static final Function<Identifier, RenderLayer> TEX_TRI_FAN = id -> RenderLayer.of("coherent_layer_tex_tri_fan", 256, PIPELINE_TEX_TRI_FAN, textureParams(id));
