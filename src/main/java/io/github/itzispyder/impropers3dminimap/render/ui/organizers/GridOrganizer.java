package io.github.itzispyder.impropers3dminimap.render.ui.organizers;
...
public class GridOrganizer implements Organizer<GuiElement> {
    ...
    public void createPanel(int height) {
        panel = new ScrollPanelElement(startX, startY, (cellWidth + gap) * maxPerRow + gap, height);
    }
